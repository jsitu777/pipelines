...
def get_tabnet_study_spec_parameters(
  ...
  if prediction_type == 'regression':
    return _format_tabnet_regression_study_spec_parameters(
        params, training_budget_bucket)
  return params


def _format_tabnet_regression_study_spec_parameters(
    params: List[Dict[str, Any]],
    training_budget_bucket: str) -> List[Dict[str, Any]]:
  """Get regression study_spec_parameters for a TabNet hyperparameter tuning job.
  ...
  Returns:
    List of study_spec_parameters for regression.
  """
